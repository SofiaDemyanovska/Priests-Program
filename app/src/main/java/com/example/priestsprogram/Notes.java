        ...
        switch (v.getId()) {
            ...
            case R.id.btnRead:
                ...
                while (cursor.moveToNext()){
                    Toast.makeText(getApplicationContext(), "Номер: "+cursor.getString(0),Toast.LENGTH_SHORT).show();
                    Toast.makeText(getApplicationContext(), "Назва: "+cursor.getString(1),Toast.LENGTH_SHORT).show();
                    Toast.makeText(getApplicationContext(), "Нотатка: "+cursor.getString(2),Toast.LENGTH_SHORT).show();
                }
